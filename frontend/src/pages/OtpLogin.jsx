...
import { Mail, Key, ArrowLeft, Award, Shield } from 'lucide-react';
...
function OtpLogin() {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:8000/api/auth/login-verify', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  const renderStep1 = () => (
    <>
      ...
      <div className="auth-footer">
        <p>Prefer password login? <Link to="/login">Login here</Link></p>
